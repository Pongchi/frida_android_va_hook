...
for filename in os.listdir('./js'):
    if filename.startswith("kakaotalk_") and filename.endswith(".js"):
...
def main():
    try:
        ...
        pid = device.spawn(["com.kakao.talk"])  # Telegram 메신저 패키지명
        ...
        print("프로세스를 찾을 수 없습니다. Kakaotalk 앱이 실행 중인지 확인하세요.")
    except Exception as e:
