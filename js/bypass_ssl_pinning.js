...
// Hook for HttpsURLConnection setSSLSocketFactory
var HttpsURLConnection = Java.use('javax.net.ssl.HttpsURLConnection');
HttpsURLConnection.setSSLSocketFactory.implementation = function(factory) {
    console.log("[*] HttpsURLConnection.setSSLSocketFactory called: " + factory);
    this.setSSLSocketFactory(factory);
};

// Additional hooks for OkHttp and TrustManagerImpl

// OkHttp bypass (CertificatePinner)
try {
    ...
    OkHttp_CertificatePinner.check.overload('java.lang.String', 'java.util.List').implementation = function(a, b) {
        console.log('[*] OkHttp bypassed for: ' + a);
        return;
    };
    console.log("[+] OkHttp (CertificatePinner) bypassed");
} catch (err) {
    console.log("[ ] OkHttp (CertificatePinner) not found or failed to bypass");
}
...
try {
    ...
    console.log("[ ] TrustManagerImpl not found or failed to bypass");
}

// Add WebView SSL bypass
try {
    ...
    console.log("[ ] WebView SSL handler not found or failed to bypass");
}
...
console.log("Cert Pinning Bypass setup completed");
